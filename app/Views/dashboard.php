    ...
    <div class="lg:col-span-9 space-y-10">
        ...
        <div id="todo-container" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <?php if (empty($todoTasks)): ?>
                <div class="col-span-full glass-panel py-24 text-center rounded-8xl border-dashed border-3 border-indigo-200 bg-white/20">
                    ...
                    <div class="glass-card p-8 rounded-6xl flex flex-col justify-between gap-8 group bg-white/80 hover:bg-white border border-white shadow-sm transition-all" data-category="<?php echo $cat; ?>">
                        <div class="flex justify-between items-center">
                            <div class="flex gap-5">
                                <div class="w-16 h-16 rounded-3xl bg-slate-50 shadow-inner flex items-center justify-center text-3xl group-hover:scale-110 transition-transform border border-slate-100">
